...
```bash
<skill_dir>/python/runtime/python.exe <skill_dir>/scripts/extract_content.py <file1.pdf> <file2.docx> source_content.json
```
...
```bash
<skill_dir>/python/runtime/python.exe <skill_dir>/scripts/project_manager.py init <project_name> --format ppt169
```
...
```bash
<skill_dir>/python/runtime/python.exe <skill_dir>/scripts/analyze_template.py <template.pptx> <project_dir>/backgrounds/
```
...
```bash
<skill_dir>/python/runtime/python.exe <skill_dir>/scripts/fix_svg.py <project_dir>/svg_output/slide_01.svg <project_dir>/svg_output/slide_01.svg
...
```bash
<skill_dir>/python/runtime/python.exe <skill_dir>/scripts/check_svg.py <project_dir>/svg_output/slide_01.svg --config <skill_dir>/template_config.json --mode <fast|validate>
# 对每页重复
```
...
```bash
<skill_dir>/python/runtime/python.exe <skill_dir>/scripts/save_notes.py <project_dir> <notes_json>
```
...
```bash
<skill_dir>/python/runtime/python.exe <skill_dir>/scripts/svg_to_pptx.py <project_dir>
```
...
```bash
<skill_dir>/python/runtime/python.exe <skill_dir>/scripts/export_previews.py <project_dir>
```
...
```bash
<skill_dir>/python/runtime/python.exe <skill_dir>/scripts/export_pdf.py <input.pptx> <output.pdf>
```
