...
// crash overlay. ResizeObserver loop is Chromium layout noise triggered by
// React/ReactFlow/Konva during resize — harmless, Chrome downgrades to console
// but WebView2 surfaces as a popup.
