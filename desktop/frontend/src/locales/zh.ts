...
export const zh: Record<DictKey, string> = {
  ...
  // Skill Store
  "settings.tab.store": "商店",
  "store.search": "搜索技能…",
  "store.sort.recommended": "推荐",
  "store.sort.stars": "最多星标",
  "store.sort.installs": "最多安装",
  "store.sort.updated": "最近更新",
  "store.sort.newest": "最新发布",
  "store.install": "安装",
  "store.installed": "已安装",
  "store.update": "更新",
  "store.uninstall": "卸载",
  "store.updatesAvailable": "{n} 个技能可更新",
  "store.noResults": "没有找到相关技能",
  "store.loading": "加载中…",
  "store.by": "来自",
  "store.version": "版本",
  "store.stars": "星标",
  ...
  "store.security.suspicious": "可疑",
  "store.loadMore": "加载更多",
  "store.clearSearch": "清除搜索",
  "store.changelog": "更新日志",
  "store.confirmUninstall": "确定卸载 {name} 吗？",
  "store.toast.installed": "{name} 已安装，技能已可用",
  "store.toast.uninstalled": "{name} 已卸载",
  "store.error.loadFailed": "加载失败，请检查网络",
  "store.error.installFailed": "安装失败，请重试",
  "store.error.uninstallFailed": "卸载失败，请重试",
  "store.error.connectFailed": "连接失败，请检查地址",
  "store.setup.title": "连接技能商店",
  "store.setup.desc": "技能商店让你发现和安装社区共享的 Agent 技能。默认关闭，连接后才会上网获取数据。",
  "store.setup.connectClawHub": "连接 ClawHub",
  "store.setup.addCustom": "添加自定义源",
  "store.setup.urlPlaceholder": "输入 registry API 地址…",
  "store.setup.connect": "连接",
  "store.setup.connected": "已连接，技能商店已开启",
  "store.setup.note": "提示：你可以随时在设置中关闭商店。",
