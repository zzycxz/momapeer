...
export const en = {
  ...
  "store.search": "Search skills…",
  "store.sort.recommended": "Recommended",
  "store.sort.stars": "Most Stars",
  "store.sort.installs": "Most Installs",
  ...
  "store.updatesAvailable": "{n} update(s) available",
  "store.noResults": "No skills found",
  ...
  "store.security.clean": "Clean",
  "store.security.suspicious": "Suspicious",
  "store.loadMore": "Load more",
  "store.clearSearch": "Clear search",
  "store.changelog": "Changelog",
  "store.confirmUninstall": "Uninstall {name}?",
  "store.toast.installed": "{name} installed and ready to use",
  "store.toast.uninstalled": "{name} uninstalled",
  "store.error.loadFailed": "Failed to load — check your network",
  "store.error.installFailed": "Install failed — please retry",
  "store.error.uninstallFailed": "Uninstall failed — please retry",
  "store.error.connectFailed": "Connection failed — check the URL",
  "store.setup.title": "Connect to a Skill Store",
  "store.setup.desc": "Discover and install community-built Agent skills. The store is off by default — enabling it allows network access to fetch listings.",
  "store.setup.connectClawHub": "Connect ClawHub",
  "store.setup.addCustom": "Add Custom Source",
  "store.setup.urlPlaceholder": "Enter registry API URL…",
  "store.setup.connect": "Connect",
  "store.setup.connected": "Connected — skill store is now active",
  "store.setup.note": "Tip: You can disable the store anytime in settings.",
